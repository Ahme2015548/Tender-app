            ...
            <div className="modal-header text-white" 
              ...
              <h5 className="modal-title fw-bold">
                ...
                {employeeData?.fullName && (
                  <small className="ms-2 opacity-75">({employeeData.fullName})</small>
                )}
              </h5>
              <button 
                type="button" 
              ...
              <div className="mb-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <h6 className="mb-0 fw-bold text-success">مكتبة الوثائق</h6>
                  ...
                  <div style={{ marginTop: '10px', marginBottom: '10px' }}>
                    ...
                    <button
                      ...
                      onClick={() => {
                        console.log('💼 Employee upload button clicked');
                        const fileInput = document.getElementById('employeeDocumentUpload');
                        if (fileInput) {
                          fileInput.click();
                          console.log('💼 Employee file input triggered');
                        } else {
                          console.error('❌ Employee file input not found');
                        }
                      }}
                ...
                {(() => {
                  console.log('🔄 EMPLOYEE MODAL RENDER CHECK:', new Date().toLocaleTimeString());
                  console.log('📊 Employee documents state:', {
                            ...
                            <tr key={document.id || `doc-${index}`}>
                              ...
                              <td className="text-center">
                                <div className="d-flex align-items-center justify-content-center">
                                  ...
                                  <span className="fw-bold text-success" title={fileName}>
            ...
            <div className="modal-footer bg-light" style={{ borderRadius: '0 0 12px 12px', padding: '20px' }}>
              <div className="d-flex" style={{ gap: '10px' }}>
                ...
                <button 
                  type="button" 
                  className="btn btn-success"
                  onClick={() => showSuccess('الوثائق تحفظ تلقائياً مع الموظف', 'تم الحفظ')}
                  style={{ 
                    height: '32px', 
                    width: '80px', 
                    borderRadius: '6px', 
