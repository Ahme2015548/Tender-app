            ...
            <div className="app-container">
              <div className="app-hero-header d-flex align-items-center px-3 py-2 border-top">
                <ol className="breadcrumb m-0">
                  ...
                  <li className="breadcrumb-item text-secondary" aria-current="page">منتج محلي</li>
                </ol>
              </div>
              ...
              <div className="app-content-area p-3">
                <div className="local-products-table">
                  <LocalProductsList 
