...
import ManufacturedProductsListFixed from '../components/ManufacturedProductsListFixed';
import { ActivityProvider, AutoActivityTracker } from '../components/ActivityManager';
import { useActivityTimeline } from '../contexts/ActivityTimelineContext';

function ManufacturedProductsListContent() {
...
export default function ManufacturedProductsList() {
  return (
    <ActivityProvider>
      <AutoActivityTracker>
        <ManufacturedProductsListContent />
      </AutoActivityTracker>
    </ActivityProvider>
  );
}