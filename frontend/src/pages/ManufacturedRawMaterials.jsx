...
function ManufacturedRawMaterialsContent() {
  ...
  const handleConfirmQuantities = async () => {
    try {
      ...
      showSuccess(`تم إضافة ${productItems.length} مادة خام للمنتج المصنع مع ربط الأسعار الديناميكي`, 'تمت الإضافة');
      ...
      showError('فشل في إضافة المواد الخام للمنتج المصنع - تحقق من البيانات', 'خطأ في النظام');
    }
  };
...
export default function ManufacturedRawMaterials() {
  return (
    <ActivityProvider>
      <AutoActivityTracker>
        <ManufacturedRawMaterialsContent />
      </AutoActivityTracker>
    </ActivityProvider>
  );
}